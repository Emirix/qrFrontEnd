    ...
    <div className="kategori gir">
      <div className="kutu w-90 mx-auto mt-3 py-2 px-2">
        <h4 className="fw-bold mb-0 p-0 d-flex center-y">
          <i className="gg-list me-1"></i>Kategoriler
        </h4>
      </div>

      {kategoriler == null ? (
        <div className="w-90 mx-auto h-30 mt-3">
          <div className="h-30 skeleton-box "></div>
        </div>
      ) : (
        <Link
          smooth
          to={"/menu/" + restoran}
          className="bg-mavi kutu w-90 mx-auto mt-3 py-3 px-2 d-flex align-items-center justify-content-center"
        >
          <svg
            fill="white"
